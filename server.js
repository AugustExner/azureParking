...
console.log("heading", heading)
  ...
  try {
    ...
    const { candidateSpots, direction } = await findCandidateSpots(oldLat, oldLng, newLat, newLng, heading);
...
async function findCandidateSpots(oldLat, oldLng, newLat, newLng, heading) {
